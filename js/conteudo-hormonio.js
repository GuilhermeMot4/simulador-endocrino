    ...
    function atualizarConteudo(valorHormonio) {
        ...
        switch (valorHormonio) {
            ...
            case 'cortisol':
                ...
                conteudoConclusao2.textContent = "Esses problemas incluem aumento do risco de doenças cardiovasculares, distúrbios do sono, ganho de peso, pressão arterial elevada, diminuição da imunidade e distúrbios metabólicos. O cortisol é um lembrete de que o equilíbrio é essencial no sistema endócrino, pois um excesso ou uma deficiência podem causar impactos significativos na saúde.";
                break;
            case 'lh':
                ...
                conteudoConclusao2.textContent = "Desequilíbrios nos níveis de LH podem resultar em problemas de fertilidade em ambos os sexos. Em mulheres, a ausência de um pico de LH pode indicar anovulação, enquanto em homens, a deficiência de LH pode afetar a produção de testosterona. O LH ilustra como a regulação hormonal é fundamental para o funcionamento do sistema reprodutivo.";
                break;
            case 'testosterona':
            ...
            case 'trh':
                ...
                conteudoConclusao2.textContent = "Os hormônios tireoidianos têm um impacto significativo no controle do metabolismo, temperatura corporal e crescimento. Desregulações no TRH ou no TSH podem levar a distúrbios da tireoide, como hipotireoidismo e hipertireoidismo. O TRH nos mostra como os hormônios agem em conjunto para manter o equilíbrio do organismo.";
                break;
            case 'tsh':
                ...
                conteudoConclusao2.textContent = "Níveis anormais de TSH podem ser indicativos de distúrbios da tireoide, como hipertireoidismo, caracterizado por níveis excessivamente altos de hormônios tireoidianos, ou hipotireoidismo, que ocorre quando a tireoide não produz hormônios em quantidade suficiente. O TSH nos ensina como os hormônios desempenham um papel crucial na regulação do corpo e como desequilíbrios podem afetar significativamente a qualidade de vida.";
                break;
        }
